...
import (
	...
	dstsdb "github.com/grafana/dskit/storage/tsdb"
	...
	return &metadata.Meta{
		...
		Thanos: metadata.Thanos{
			...
			Labels: map[string]string{
				dstsdb.TenantIDExternalLabel: userID,
			},
...
func (m *Block) String() string {
	minT := timeutil.TimeFromMillis(m.MinTime).UTC()
	maxT := timeutil.TimeFromMillis(m.MaxTime).UTC()
