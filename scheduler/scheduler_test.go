...
func TestSchedulerEnqueueWithFrontendDisconnect(t *testing.T) {
	...
	testutil.Poll(t, time.Second, float64(1), func() interface{} {
	...
	testutil.Poll(t, time.Second, float64(0), func() interface{} {
		return promtest.ToFloat64(scheduler.connectedFrontendClients)
	})
...
func TestTracingContext(t *testing.T) {
	...
	opentracing.GlobalTracer().Inject(sp.Context(), opentracing.HTTPHeaders, (*grpcutil.HttpgrpcHeadersCarrier)(req.HttpRequest))
...
func TestSchedulerForwardsErrorToFrontend(t *testing.T) {
	...
	testutil.Poll(t, 2*time.Second, true, func() interface{} {
