...
type fakePusher struct {
	request  *dskitpb.WriteRequest
	response *dskitpb.WriteResponse
	err      error
}

func (p *fakePusher) Push(ctx context.Context, r *dskitpb.WriteRequest) (*dskitpb.WriteResponse, error) {
	p.request = r
...
func TestPusherAppendable(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			pusher.response = &dskitpb.WriteResponse{}
			a := pa.Appender(ctx)
...
func TestPusherErrors(t *testing.T) {
	for name, tc := range map[string]struct {
		...
		t.Run(name, func(t *testing.T) {
			...
			pusher := &fakePusher{err: tc.returnedError, response: &dskitpb.WriteResponse{}}
