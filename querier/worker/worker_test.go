...
func TestResetConcurrency(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			testutil.Poll(t, 250*time.Millisecond, tt.expectedConcurrency, func() interface{} {
			...
			testutil.Poll(t, 250*time.Millisecond, tt.expectedConcurrencyAfterTargetRemoval, func() interface{} {
				return getConcurrentProcessors(w)
			})
